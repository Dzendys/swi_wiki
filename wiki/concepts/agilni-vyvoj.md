...
*Poznámka*: I když jsou body vpravo důležité, bodů vlevo si ceníme více.
...
## Výhody a rizika
- **Výhody**: Rychlejší dodávky, rychlá reakce na změny, neustálá zpětná vazba. Vhodné zejména pro menší projekty.
- **Rizika**: Vyžaduje velmi aktivního zákazníka (často nedostatek času nebo pravomocí na jeho straně), obtížné pro velké týmy, nepochopení agility jako absence disciplíny ("marketingový buzzword").
...
---
#agile #agilni-manifest #software-engineering #management #BI-SWI
