Z dostupných materiálů se podařilo získat doslovný přepis velmi detailního zadání týkajícího se zdravotních pojišťoven, kont a e-receptů, které studenti vyfotili přímo z originálního zadání testu. Zde je jeho plné znění:
...
**Výskyty tohoto tématu:**
*   15. 6. 2012 (zde se téma objevilo poprvé jako zcela nové)
*   16. 5. 2014
*   12. 6. 2025 (objevilo se stručné téma označené jako „Elektronická zdravotní karta pacienta“, u kterého je vysoce pravděpodobné, že šlo o recyklaci nebo drobnou obměnu tohoto zadání)
